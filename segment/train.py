...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='../working/yolov5/models/segment/yolov5n-seg.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='../working/yolov5/data/coco128-seg.yaml', help='dataset.yaml path')
